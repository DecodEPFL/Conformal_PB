...
- **Safety vs. Performance Tradeoff**: Our method achieves 1% collision frequency with mean tracking cost of 1.05, while the baseline requires 8× higher penalty coefficient to match safety, suffering 16% collision frequency at equivalent cost.
